...
export default {
  ...
  render(createElement) {
    return createElement('div', {
      ...
      }, (this.info.role === 0 ? this.aside : this.temparr).map(menu => (menu.children === undefined ? elMenuItem : elSubmenu).call(this, createElement, menu))),
  ...
  methods: {
    ...
    roleStore(){
      ...
      console.log('testarr',this.temparr); 
    }
  }
}